...
<body>
  ...
  include "../config.php";
  $sql = mysqli_query($mysqli, "SELECT * FROM tb_member WHERE idMember='$id'");
  ...
  if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE tb_member SET namaMember='$unama', alamat='$ualamat', 
    telepon='$uphone', username='$uuser', password='$upass' WHERE idMember='$uid'");
    if (!$result) {
